...
| 03 | [Commission accounts + TDS](03-commission-tds.md) | Accrual DocType on Booking; JE + PI/TDS still open |
| 04 | [Concurrent unit lock on a bench](04-concurrent-lock.md) | CAS in code; real bench race protocol still open |
| 05 | [Channel isolation fixtures](05-channel-isolation-fixtures.md) | Query conditions in code; Role fixtures + daily report gate still open |
